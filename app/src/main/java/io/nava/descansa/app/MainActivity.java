...
public class MainActivity extends AppCompatActivity {
    ...
    private Button themeButton;  // NEW: Theme button
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // NEW: Apply stored theme before setting content view
        applyStoredTheme();
    ...
    private void initializeUI() {
        ...
        themeButton = binding.themeButton;  // NEW: Theme button
    ...
    private void setupButtonListeners() {
        ...
        themeButton.setOnClickListener(v -> showThemeSelectionDialog());  // NEW: Theme button listener
    }
